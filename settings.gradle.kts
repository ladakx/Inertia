...
include("inertia-nms-v1_18_R1")
include("inertia-nms-v1_18_R2")
include("inertia-nms-v1_19_R1")
include("inertia-nms-v1_19_R2")
...
include("inertia-nms-v1_21_R4")
include("inertia-nms-v1_21_R5")
include("inertia-nms-v1_21_R6")
include("inertia-nms-v1_21_R7")
include("inertia-nms-v1_21_R8")