...
/**
 * Network-only visual for non-Display vanilla entities (e.g. Boat/Shulker/Interaction).
 * Uses yaw/pitch for rotation (teleport packet), without Display transformation metadata.
 */
public abstract class AbstractSimpleEntityVisual implements NetworkVisual {
    ...
    protected float yawFrom(Quaternionf q) {
        // Derive yaw/pitch from rotated forward vector (0,0,1)
