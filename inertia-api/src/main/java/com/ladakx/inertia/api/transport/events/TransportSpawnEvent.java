...
public final class TransportSpawnEvent extends Event {
    private static final HandlerList HANDLERS = new HandlerList();
    private final TransportSpawnPayload payload;

    public TransportSpawnEvent(@NotNull TransportSpawnPayload payload) {
        super(false);
        this.payload = Objects.requireNonNull(payload, "payload");
    }

    public @NotNull TransportSpawnPayload payload() {
        return payload;
    }
