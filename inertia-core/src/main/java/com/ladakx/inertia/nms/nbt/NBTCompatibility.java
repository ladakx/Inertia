...
import com.ladakx.inertia.utils.AttributeType;
...
public interface NBTCompatibility {
    ...
    boolean hasString(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key);
    ...
    default String getString(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key) {
        return getString(bukkitEntity, plugin, key, null);
    }
    ...
    String getString(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, String def);
    ...
    void setString(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, String value);
    ...
    default int getInt(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key) {
        return getInt(bukkitEntity, plugin, key, 0);
    }
    ...
    int getInt(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, int def);
    ...
    void setInt(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, int value);
    ...
    boolean hasDouble(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key);
    ...
    default double getDouble(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key) {
        return getDouble(bukkitEntity, plugin, key, 0.0);
    }
    ...
    double getDouble(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, double def);
    ...
    void setDouble(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, double value);
    ...
    boolean hasArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key);
    ...
    default int[] getArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key) {
        return getArray(bukkitEntity, plugin, key, DO_NOT_MODIFY_ME);
    }
    ...
    int[] getArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, int[] def);
    ...
    void setArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, int[] value);
    ...
    boolean hasStringArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key);
    ...
    default String[] getStringArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key) {
        return getStringArray(bukkitEntity, plugin, key, DO_NOT_MODIFY_ME_STRING);
    }
    ...
    String[] getStringArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, String[] def);
    ...
    void setStringArray(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key, String[] value);
    ...
    void remove(@NotNull Entity bukkitEntity, @NotNull String plugin, @NotNull String key);
    ...
    default void setAttribute(@NotNull ItemStack bukkitItem, @NotNull AttributeType attribute, @Nullable AttributeSlot slot, double value) {
        ...
        AttributeModifier hand = new AttributeModifier(slot == null ? attribute.getUUID() : slot.modify(attribute.getUUID()), "RoseCoreAttribute", value, AttributeModifier.Operation.ADD_NUMBER,
