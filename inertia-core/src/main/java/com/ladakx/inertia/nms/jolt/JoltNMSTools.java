...
public interface JoltNMSTools {
     ...
     */
    AaBox boundingBox(BlockState blockState);
     ...
     */
    List<AaBox> boundingBoxes(BlockState blockState);
     ...
     */
    AaBox getOcclusionShape(Chunk chunk, int x, int y, int z);
