...
public class VisualState {
    ...
    public void set(VisualEntity visual, Vector3f position, Quaternionf rotation, Vector3f centerOffset, boolean rotateTranslation, boolean visible) {
        this.visual = visual;
